      ...
      {showSignupForm ? (
        <>
          ...
          <form onSubmit={handleSignup}>
            ...
            <input
              className='bg-goblue text-black font-bold py-1 px-4 rounded cursor-pointer'
              id='signup-btn'
              type='submit'
              value='Sign up'
            />
          ...
          <button
            className='bg-goblue text-black font-bold py-1 px-4 rounded cursor-pointer mt-4'
